...
import profile from "../assets/hero-profile-img.png";
  ...
  return (
    <div className='bg-black/10 min-h-screen sticky z-0 top-0'>
      ...
      <div className="flex lg:items-center md:justify-end lg:justify-center justify-center">
        <img className='absolute z-1 object-cover lg:w-110 md:w-90 w-80 object-center lg:top-45 md:top-40 md:pt-0 pt-10 opacity-92' src={profile} alt="" />
      </div>
